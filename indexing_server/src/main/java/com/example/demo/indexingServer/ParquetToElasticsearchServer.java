...
public class ParquetToElasticsearchServer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        File root = new File("/home/rowan/-Weather-Stations-Monitoring-System/central-station/archive");
        if (!root.exists()) {
        ...
        for (File file : parquetFiles) {
            ...
            List<WeatherStation> statuses = server.readParquet(file);
    ...
    public void indexToElasticsearch(List<WeatherStation> statuses) throws IOException {
        ...
        for (WeatherStation status : statuses) {
    ...
    public List<WeatherStation> readParquet(File parquetFile) throws IOException {
        ...
        try (ParquetReader<GenericRecord> reader = AvroParquetReader.<GenericRecord>builder(path).build();
            ...
            while ((record = reader.read()) != null) {
                ...
                WeatherStation status = new WeatherStation();
                ...
                WeatherStation.Weather weather = new WeatherStation.Weather();
